...
static void process_prec2(struct EquationAlg* eq)
{
    ...
    eq->res_num_base_d = calculate_result(eq->op1_num_base_d, eq->oprtr, eq->op2_num_base_d);
    eq->res_num_var = eq->op1_num_var;
    eq->res_num_exp_d = calculate_result(eq->op1_num_exp_d, exp_oprtr, eq->op2_num_exp_d);
}
